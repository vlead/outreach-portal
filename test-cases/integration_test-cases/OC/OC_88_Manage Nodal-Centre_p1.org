...
* Objective
  - To be able to delete the created Nodal Centre
...
* Test Steps
  ...
  2. Select the Nodal Centre and click on the corresponding
     delete  button present under the actions column in the page

* Expected result
  1. Refer to the [[https://github.com/vlead/outreach-portal/blob/master/test-cases/integration_test-cases/OC/OC_79_Manage%20Nodal-Centres.org][OC_79_Manage-Nodal-centres.org]] 
  2. The selected Nodal Centre should get deleted
