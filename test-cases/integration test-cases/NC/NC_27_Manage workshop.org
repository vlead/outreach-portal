...
* Test Steps
  ...
  2. Enter the invalid data in the Labs planned field and enter the valid data in remaining all the fields 
  3. Hit enter or click submit button.

* Expected result
  1. Refer to the step id 14
  2. An error message should be displayed on the screen as to enter the valid data in the Labs planned field
