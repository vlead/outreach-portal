...
* Post conditions
  - Nil
* Test Steps
  1. Refer to the [[https://github.com/Virtual-Labs/outreach-portal/blob/master/test-cases/integration_test-cases/OC/OC_06_Login%20page.org][OC_06_Login page.org]]
  2. Enter the invalid password in the password field
  3. Hit enter or click signin button.

* Expected result
  1. Refer to th [[https://github.com/Virtual-Labs/outreach-portal/blob/master/test-cases/integration_test-cases/OC/OC_06_Login%20page.org][OC_06_Login page.org]] 
