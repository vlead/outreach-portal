...
* Design
  ...
  As part of the bootstrap the following tasks are
  accomplished. 
...
- name: Install pip packages
  shell: pip install Flask Flask-SQLAlchemy requests flask-cors flask-testing Flask-OAuthlib werkzeug==0.16.1
