...
#+BEGIN_SRC sql :tangle scripts/create-database.sql 
DROP DATABASE IF EXISTS outreach;
...
#+BEGIN_SRC sql :tangle scripts/procedures.sql 
DROP VIEW IF EXISTS approved_workshops;
...
#+BEGIN_SRC sql :tangle scripts/procedures.sql 
DROP TABLE IF EXISTS institute_analytics;
...
#+BEGIN_SRC sql :tangle scripts/procedures.sql 
DROP PROCEDURE IF EXISTS refresh_institute_analytics_now;
...
#+BEGIN_SRC sql :tangle scripts/procedures.sql 
DROP PROCEDURE IF EXISTS refresh_analytics_now;
...
#+BEGIN_SRC sql :tangle scripts/procedures.sql 
DROP TABLE IF EXISTS nc_analytics;
...
#+BEGIN_SRC sql :tangle scripts/procedures.sql 
DROP PROCEDURE IF EXISTS refresh_nc_analytics_now;
