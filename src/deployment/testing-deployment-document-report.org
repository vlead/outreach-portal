...
** Validity of Data
*** Scope for testing
   - Testing can be done only through the IoC and NC login of
IIIT Hyderabad. 
   - Login details of Admin are not available. 
   - It is also not possible to test through other institute
login also as each institute has different logins for both
IOC and NC. 

*** Testing through IOC Login
    - The following table has the existing data compared with the
new data through IoC login of IIIT hyderabad. 
...
*** Testing through NC login
    - The following table has the existing data compared with the
new data through NC login of IIIT Hyderabad.
