...
* Purpose
Functional Specifications provide detailed information on
how the application/system should work on implementation of
the requirements. This document is created based on the
...
[[img/nodal-coordinators-form.png]]

This is the how the NC details on the page looks
[[img/nodal-coordinators-details.png]]
