...
|       | history details           |        |          |        |            |            |         |           |
|-------+---------------------------+--------+----------+--------+------------+------------+---------+-----------|
|    4. | Tool tips on Create       | [[https://github.com/vlead/outreach-portal/issues/274][#274]]   |       24 |        | 09-07-2018 |            | Backlog | Mrudhvika |
|       | workshop fields (For e.g. |        |          |        | 11-07-2018 |            |         |           |
...
|       | page                      |        |          |        |            |            |         |           |
|-------+---------------------------+--------+----------+--------+------------+------------+---------+-----------|
|    8. | Identify and remove       | [[https://github.com/vlead/outreach-portal/issues/295][#295]]   |       16 |        | 12-07-2018 |            | Backlog | Mrudhvika |
|       | all the broken links in   |        |          |        | 16-07-2018 |            |         |           |
|       | portal                    |        |          |        |            |            |         |           |
|-------+---------------------------+--------+----------+--------+------------+------------+---------+-----------|
| Total |                           |        |  312 est |        |            |            |         |           |
|-------+---------------------------+--------+----------+--------+------------+------------+---------+-----------|
