...
|       | of the nodal coordinator  |        |          |                                                      |        | 29-05-2018 | 30-05-2018 |         |           |
|-------+---------------------------+--------+----------+------------------------------------------------------+--------+------------+------------+---------+-----------|
...
|       |                           |        |          | or should check if angularjs has any inbuilt filters |        |            |            |         |           |
...
|-------+---------------------------+--------+----------+------------------------------------------------------+--------+------------+------------+---------+-----------|
|    5. | Grid View for exporting   | [[https://github.com/vlead/outreach-portal/issues/275][#275]]   |       48 |                                                      |        | 18-07-2018 |            | Backlog | Sadhana   |
|       | the workshop, Nodal       |        |          |                                                      |        | 25-07-2018 |            |         |           |
|       | centers and usage data    |        |          |                                                      |        |            |            |         |           |
|-------+---------------------------+--------+----------+------------------------------------------------------+--------+------------+------------+---------+-----------|
|    6. | Segregation of Online and | [[https://github.com/vlead/outreach-portal/issues/276][#276]]   |       32 | Need to add filter(for eg: radio                     | 24     | 04-07-2018 | 04-07-2018 | Done    | Sadhana   |
|       | offline workshops         |        |          | buttons or dropdownbox) in workshops                 |        | 09-07-2018 | 09-07-2018 |         |           |
|       |                           |        |          | template and should understand how the               |        |            |            |         |           |
|       |                           |        |          | workshops data is getting populated in               |        |            |            |         |           |
|       |                           |        |          | page. Then need to add a function                    |        |            |            |         |           |
|       |                           |        |          | in workshops template respective                     |        |            |            |         |           |
|       |                           |        |          | controller to filter the data and                    |        |            |            |         |           |
|       |                           |        |          | populate in template based on user                   |        |            |            |         |           |
|       |                           |        |          | choosen workshop version.                            |        |            |            |         |           |
|-------+---------------------------+--------+----------+------------------------------------------------------+--------+------------+------------+---------+-----------|
|    7. | Fix loading time of       | [[https://github.com/vlead/outreach-portal/issues/294][#294]]   |       64 |                                                      |        | 17-07-2018 |            | Backlog | Mrudhvika |
|       | data in portal main       |        |          |                                                      |        | 25-07-2018 |            |         | Sadhana   |
|       | page                      |        |          |                                                      |        |            |            |         |           |
|-------+---------------------------+--------+----------+------------------------------------------------------+--------+------------+------------+---------+-----------|
