...
|      | NC to the OC                  |          |   |   |
|------+-------------------------------+----------+---+---|
|   5. | [[https://github.com/vlead/outreach-portal/milestone/10][Disallow]] creation of multiple |       15 |   |   |
|      | workshops when one single     |          |   |   |
|      | workshop is created           |          |   |   |
|------+-------------------------------+----------+---+---|
|   7. | [[https://github.com/vlead/outreach-portal/milestone/12][Re design]] and re implement    |      120 |   |   |
|      | the portal                    |          |   |   |
|------+-------------------------------+----------+---+---|
|   6. | Support                       |          |   |   |
|------+-------------------------------+----------+---+---|
