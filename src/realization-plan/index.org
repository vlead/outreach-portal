...
|      |                                 |    days) |   |   |
|------+---------------------------------+----------+---+---|
|   1. | Set up the test machine         |       10 |   |   |
|      | and implement, test the         |          |   |   |
|      | back up scripts.                |          |   |   |
|------+---------------------------------+----------+---+---|
|   2. | Update the data model           |        7 |   |   |
|      | and work on the scenarios       |          |   |   |
|      | document                        |          |   |   |
|------+---------------------------------+----------+---+---|
|   3. | Allow NC to view approved       |       10 |   |   |
|      | workshops                       |          |   |   |
|------+---------------------------------+----------+---+---|
|   4. | Workshops created by            |       15 |   |   |
|      | NC are not seen by OC           |          |   |   |
|------+---------------------------------+----------+---+---|
|   5. | Multiple workshops              |       15 |   |   |
|      | getting created                 |          |   |   |
|------+---------------------------------+----------+---+---|
|   7. | Re Design and re implementation |       90 |   |   |
|      | of the portal                   |          |   |   |
|------+---------------------------------+----------+---+---|
|   6. | Support                         |          |   |   |
|------+---------------------------------+----------+---+---|
