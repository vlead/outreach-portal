...
#+NAME: create-dump
#+BEGIN_SRC sh
1 0 * * * sh /root/labs/outreach-portal/scripts/backup
#+END_SRC
...
#+NAME: alert
#+BEGIN_SRC sh
1 */8 * * * sh /var/www/scripts/disk-space.sh
#+END_SRC
...
#+NAME: copy-files
#+BEGIN_SRC sh
1 */4 * * * sh /var/www/scripts/copy-files.sh
#+END_SRC

** Copy Dump
#+NAME: copy-dump
#+BEGIN_SRC sh
10 0 * * * sh /var/www/scripts/copy-dump.sh
#+END_SRC


* Tangle
#+BEGIN_SRC sh :tangle cronjobs :eval no :noweb yes
<<create-dump>>
<<analytics>>
<<alert>>
<<copy-dump>>
