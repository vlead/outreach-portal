...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_name(self):
        current_app.logger.debug("get name of the Role: %s" % name)
        return self.name
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_name(self):
        current_app.logger.debug("get name of the User: %s" % name)
        return self.name
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_institute_name(self):
        current_app.logger.debug("get institute_name of the User: %s" % institute_name)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_role(self):
        current_app.logger.debug("get role of the User: %s" % role.name)
        return self.role
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_created(self):
        current_app.logger.debug("get time of creation of the User: %s" % created)
        return self.created
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_name(self):
        current_app.logger.debug("get name of the Reference Document: %s" % name)
        return self.name
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no 
    def get_path(self):
        current_app.logger.debug("get path of the Reference Document: %s" % path)
        return self.path
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no 
    def get_user(self):
        current_app.logger.debug("get user of the Reference Document: %s" % user.name)
        return self.user
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_name(self):
        current_app.logger.debug("set the name of the status: %s" % name)
        return self.name
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_name(self):
        current_app.logger.debug("get the name of the Workshop: %s" % name)
        return self.name
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_date(self):
        current_app.logger.debug("get the date of the Workshop: %s" % date)
        return self.date
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_user(self):
        current_app.logger.debug("get the user of the Workshop: %s" % user.name)
        return self.user
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_created(self):
        current_app.logger.debug("get the time of creation of the Workshop: %s" % created)
        return self.created
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_last_updated(self):
        current_app.logger.debug("get the last updated time of the Workshop: %s" % last_updated)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_participating_institutes(self):
        current_app.logger.debug("get the participating_institutes of the Workshop: %s" % participating_institutes)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_no_of_participants_expected(self):
        current_app.logger.debug("get the no_of_participants_expected of the Workshop: %s" % no_of_participants_expected)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_no_of_participants_attended(self):
        current_app.logger.debug("get the participants_attended for the Workshop: %s" % participants_attended)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_no_of_expts_conducted(self):
        current_app.logger.debug("get the number of experiments conducted for the Workshop: %s" % experiments_conducted)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_duration_of_sessions(self):
        current_app.logger.debug("get the duration_of_sessions for the Workshop: %s" % duration_of_sessions)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_disciplines(self):
        current_app.logger.debug("get the disciplines for the Workshop: %s" % disciplines)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_no_of_sessions(self):
        current_app.logger.debug("get the no_of_sessions for the Workshop: %s" % no_of_sessions)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_planned_labs(self):
        current_app.logger.debug("get the labs_planned for the Workshop: %s" % labs_planned)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_status(self):
        current_app.logger.debug("get the status of the Workshop: %s" % status)
        return self.status
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_cancellation_reason(self):
        current_app.logger.debug("get the cancellation_reason for the Workshop: %s" % cancellation_reason)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_not_approval_reason(self):
        current_app.logger.debug("get the not_approval_reason for the Workshop: %s" % not_approval_reason)
...
#+BEGIN_SRC python :tangle src/db.py :eval no 
    def get_created_by(self):
        current_app.logger.debug("get of the user who created the NodalCentre: %s"  % created_by.name)
...
#+BEGIN_SRC python :tangle src/db.py :eval no 
    def get_name(self):
        current_app.logger.debug("get name of the NodalCentre: %s"  % name)
        return self.name
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no 
    def get_location(self):
        current_app.logger.debug("get location of the NodalCentre : %s"  % location)
        return self.location
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_user(self):
        current_app.logger.debug("get user from NodalCoordinatorDetail Entity: %s"  % user.name)
        return self.user
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_created_by(self):
        current_app.logger.debug("get created_by user from NodalCoordinatorDetail: %s"  % created_by)
        return self.created_by
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_nodal_centre(self):
        current_app.logger.debug("get nodal_centre from NodalCoordinatorDetail: %s"  % nodal_centre)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_created(self):
        current_app.logger.debug("get time of creation from NodalCoordinatorDetail: %s"  % created)
        return self.created
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_target_workshops(self):
        current_app.logger.debug("get target_workshops from NodalCoordinatorDetail: %s"  % target_workshops)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_target_participants(self):
        current_app.logger.debug("get target_participants from NodalCoordinatorDetail: %s"  % target_participants)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_target_experiments(self):
        current_app.logger.debug("get target_experiments from NodalCoordinatorDetail: %s"  % target_experiments)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_path(self):
        current_app.logger.debug("get path of the WorkshopReport: %s"  % path)
        return self.path
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_name(self):
        current_app.logger.debug("get name of the WorkshopReport: %s"  % name)
        return self.name
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no 
    def get_workshop(self):
        current_app.logger.debug("get workshop of the WorkshopReport: %s"  % workshop.name)
...
session_list = {}
def check_authorization(email, key):
    try:
        if session_list[email] == key:
            return True
    except Exception, e:
        return False
...
def login():
    if request.method == 'POST':
        ...
        if verification_data['status'] == 'okay':
            ...
            key = str(request.form['assertion'])
...
def logout_handler():
    current_user = session._get_current_object().get('email')
    session_list.pop(current_user)
...
def upload_file(file, url):
    if file and allowed_file(file.filename):
        ...
        path = {'path': db_path}
        try:
            response = requests.put(url, data=path, headers= {'email' : session['email'], 'key' : session['key']})
...
def modify_entity(entity, id):
    ...
    if(not check_authorization(email, key)):
