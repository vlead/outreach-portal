...
class Name(object):
    def __init__(self, value):
        ...
        if re.search('[^a-zA-Z. ]+', value):
            current_app.logger.info("Type Error...")
            current_app.logger.debug("%s is not a Name type! "  % value)
            current_app.logger.error("%s is not a Name type! "  % value)
...
class Email(object):
    def __init__(self, value):
        if not re.search('[^@]+@[^@]+\.[^@]+', value):
            ...
            current_app.logger.error("%s is not an Email type! "  % value)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def __init__(self, **kwargs):
        if 'name' not in kwargs:
            current_app.logger.info("Missing Attribute...")
            current_app.logger.error("mandatory attribute `name` is missing")
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @staticmethod
    def get_by_id(id):
        current_app.logger.info("get by Role id")
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @staticmethod
    def get_all():
        current_app.logger.info("get all rows of Role entity")
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @staticmethod
    def get_all():
        current_app.logger.info("get all rows of User entity")
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @staticmethod
    def get_by_id(id):
        current_app.logger.info("get by User id")
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_email(self):
        current_app.logger.info("get email of the User: %s" % email)
        current_app.logger.debug("get email of the User: %s" % email)
        return self.email
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_last_active(self):
        current_app.logger.info("get last active time of the User: %s" % last_active)
        current_app.logger.debug("get last active time of the User: %s" % last_active)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @typecheck(name=Name)
    def set_name(self, name):
        current_app.logger.info("set name of the User with name: %s" % name.value)
        current_app.logger.debug("set name of the User with name: %s" % name.value)
        self.name = name.value
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_email(self, email):
        current_app.logger.info("set email of the User with email id: %s" % email.value)
        current_app.logger.debug("set email of the User with email id: %s" % email.value)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def set_institute_name(self, institute_name):
        current_app.logger.info("set institute name of the User with institute: %s" % institute_name.value)
        current_app.logger.debug("set institute name of the User with institute: %s" % institute_name.value)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def set_last_active(self, last_active):
        current_app.logger.info("set last active of the User with time: %s" % last_active)
        current_app.logger.debug("set last active of the User with time: %s" % last_active)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def set_toc(self, created):
        current_app.logger.info("set time of creation of the User with time: %s" % created)
        current_app.logger.debug("set time of creation of the User with time: %s" % created)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_role(self, role):
        current_app.logger.info("set role of the User with role: %s" % role)
        current_app.logger.debug("set role of the User with role: %s" % role)
        self.role = role
...
**** Constructor
#+BEGIN_EXAMPLE 
    reference_document = ReferenceDocument(name=<instance of class Name>,
                                         path=str,
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @staticmethod
    def get_all():
        current_app.logger.info("get all rows of Reference Document entity")
...
#+BEGIN_SRC python :tangle tests/test_db.py :eval no
    def test_reference_documents_get_all(self):
        ...
        doc = ReferenceDocument(name=Name("Attendance Sheet"), user=user)
        doc.save()
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @staticmethod
    def get_by_id(id):
        current_app.logger.info("get by ReferenceDocument id")
...
#+BEGIN_SRC python :tangle tests/test_db.py :eval no 
    def test_get_reference_document_by_id(self):
        ...
        reference_document = ReferenceDocument(name=Name("Attendance Sheet"), user=user)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @typecheck(name=Name)
    def set_name(self, name):
        current_app.logger.info("set the name of the ReferenceDocument: %s" % name.value)
        current_app.logger.debug("set the name of the ReferenceDocument: %s" % name.value)
        self.name = name.value
#+END_SRC
...
#+BEGIN_SRC python :tangle tests/test_db.py :eval no
    def test_set_reference_document_name(self):
        ...
        reference_document = ReferenceDocument(name=Name("Attandance Sheet"), user=user)
        reference_document.set_name(Name("College Report"))
...
#+BEGIN_SRC python :tangle src/db.py :eval no 
    ...
    def set_path(self, path):
        current_app.logger.info("set the path of the ReferenceDocument: %s" % path)
        current_app.logger.debug("set the path of the ReferenceDocument: %s" % path)
        self.path = path
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_user(self, user):
        current_app.logger.info("set the user of the ReferenceDocument: %s" % user)
        current_app.logger.debug("set the user of the ReferenceDocument: %s" % user)
        self.user = user
...
#+BEGIN_SRC python :tangle tests/test_db.py :eval no
    def test_reference_document_to_client(self):
        ...
        doc = ReferenceDocument(name=Name("Feedback"), user=user)
        doc.save()
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @staticmethod
    def get_by_id(id):
        current_app.logger.info("get by Status id")
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @staticmethod
    def get_all():
        current_app.logger.info("get all rows of Status entity")
...
#+BEGIN_SRC python :tangle tests/test_db.py :eval no
    def test_status_get_all(self):
        ...
        status.save()
        self.assertEqual("Upcoming", status.name)
#+END_SRC
***** getName: Status --> Name
#+BEGIN_SRC python :tangle src/db.py :eval no
    def get_name(self):
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @typecheck(name=Name)
    def set_name(self, name):
        current_app.logger.info("get the name of Status entity: %s" % name.value)
        current_app.logger.debug("get all rows of Status entity: %s" % name.value)
        self.name = name.value
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @staticmethod
    def get_all():
        current_app.logger.info("get all rows of Workshop entity")
...
#+BEGIN_SRC python :tangle tests/test_db.py :eval no
    def test_get_workshop_duration_of_sessions(self):
        ...
        workshop_1 = Workshop(name="Coordinators Training",
                              ...
                              no_of_participants_expected=100,
                              no_of_sessions=3, labs_planned=4,
                              status=status, duration_of_sessions=1,
                              date="Mon Nov 23 2015 06:18:26 GMT-0500 (EST)")
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @typecheck(name=str)
    def set_name(self, name):
        current_app.logger.info("set the name of Workshop entity with name: %s" % name)
        current_app.logger.debug("set the name of Workshop entity with name: %s" % name)
        self.name = name
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_location(self, location):
        current_app.logger.info("set the location of Workshop entity with name: %s" % location)
        current_app.logger.debug("set the location of Workshop entity with name: %s" % location)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @typecheck(user=User)
    def set_user(self, user):
        current_app.logger.info("set the user of Workshop entity : %s" % user)
        current_app.logger.debug("set the user of Workshop entity : %s" % user)
        self.user = user
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_date(self, date):
        current_app.logger.info("set the date of Workshop entity: %s" % date)
        current_app.logger.debug("set the date of Workshop entity: %s" % date)
        self.date = date
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_participating_institutes(self, participating_institutes):
        current_app.logger.info("set the participating_institutes of Workshop entity: %s" % participating_institutes)
        current_app.logger.debug("set the participating_institutes of Workshop entity: %s" % participating_institutes)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_no_of_participants_expected(self, no_of_participants_expected):
        current_app.logger.info("set the participants_expected of Workshop entity: %s" % participants_expected)
        current_app.logger.debug("set the participants_expected of Workshop entity: %s" % participants_expected)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_participants_attended(self, participants_attended):
        current_app.logger.info("set the participants_attended of Workshop entity: %s" % participants_attended)
        current_app.logger.debug("set the participants_attended of Workshop entity: %s" % participants_attended)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_no_of_sessions(self, no_of_sessions):
        current_app.logger.info("set the no_of_sessions of Workshop entity: %s" % no_of_sessions)
        current_app.logger.debug("set the no_of_sessions of Workshop entity: %s" % no_of_sessions)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_duration_of_sessions(self, duration_of_sessions):
        current_app.logger.info("set the duration_of_sessions of Workshop entity: %s" % duration_of_sessions)
        current_app.logger.debug("set the duration_of_sessions of Workshop entity: %s" % duration_of_sessions)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_disciplines(self, disciplines):
        current_app.logger.info("set the disciplines of Workshop entity: %s" % disciplines)
        current_app.logger.debug("set the disciplines of Workshop entity: %s" % disciplines)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_last_updated(self, last_updated):
        current_app.logger.info("set the last_updated time of Workshop entity: %s" % last_updated)
        current_app.logger.debug("set the last_updated time of Workshop entity: %s" % last_updated)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_labs_planned(self, labs_planned):
        current_app.logger.info("set the labs_planned of Workshop entity: %s" % labs_planned)
        current_app.logger.debug("set the labs_planned of Workshop entity: %s" % labs_planned)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_experiments_conducted(self, experiments_conducted):
        current_app.logger.info("set the experiments_conducted  of Workshop entity: %s" % experiments_conducted)
        current_app.logger.debug("set the experiments_conducted of Workshop entity: %s" % experiments_conducted)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_other_details(self, other_details):
        current_app.logger.info("set the other_details of Workshop entity: %s" % other_details)
        current_app.logger.debug("set the other_details of Workshop entity: %s" % other_details)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_status(self, status):
        current_app.logger.info("set the status of Workshop entity: %s" % status)
        current_app.logger.debug("set the status of Workshop entity: %s" % status)
        self.status = status
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_cancellation_reason(self, cancellation_reason):
        current_app.logger.info("set the cancellation_reason of Workshop entity: %s" % cancellation_reason)
        current_app.logger.debug("set the cancellation_reason of Workshop entity: %s" % cancellation_reason)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_not_approval_reason(self, not_approval_reason):
        current_app.logger.info("set the not_approval_reason of Workshop entity: %s" % not_approval_reason)
        current_app.logger.debug("set the not_approval_reason of Workshop entity: %s" % not_approval_reason)
...
#+BEGIN_SRC python :tangle src/db.py :eval no 
    @staticmethod
    def get_all():
        current_app.logger.info("get all rows of Nodal Centre entity")
...
#+BEGIN_SRC python :tangle src/db.py :eval no 
    @staticmethod
    def get_by_id(id):
        current_app.logger.info("get by NodalCentre id")
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_created_by(self, created_by):
        current_app.logger.info("set created by user of the NodalCentre: %s" % created_by)
        current_app.logger.debug("set created by user of the NodalCentre: %s" % created_by)
...
#+BEGIN_SRC python :tangle src/db.py :eval no 
    @typecheck(name=str)
    def set_name(self, name):
        current_app.logger.info("set name of the NodalCentre: %s" % name)
        current_app.logger.debug("set name of the NodalCentre: %s" % name)
        self.name = name
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no 
    @typecheck(location=str)
    def set_location(self, location):
        current_app.logger.info("set location of the NodalCentre: %s" % location)
        current_app.logger.debug("set location of the NodalCentre: %s" % location)
        self.location = location
#+END_SRC
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @staticmethod
    def get_all():
        current_app.logger.info("get all rows of NodalCoordinatorDetail entity")
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @staticmethod
    def get_by_id(id):
        current_app.logger.info("get by NodalCoordinatorDetail id")
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def set_last_updated(self, last_updated):
        current_app.logger.info("set last updated time of the NodalCoordinatorDetail : %s" % last_updated)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @typecheck(user=User)
    def set_user(self, user):
        current_app.logger.info("set user of the NodalCoordinatorDetail : %s" % user)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @typecheck(created_by=User)
    def set_created_by(self, created_by):
        current_app.logger.info("set created by user of the NodalCoordinatorDetail : %s" % created_by)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_nodal_centre(self, nodal_centre):
        current_app.logger.info("set nodal centre of the NodalCoordinatorDetail : %s" % nodal_centre)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def set_target_workshops(self, target_workshops):
        current_app.logger.info("set target workshops of the NodalCoordinatorDetail : %s" % target_workshops)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def set_target_participants(self, target_participants):
        current_app.logger.info("set target participants of the NodalCoordinatorDetail : %s" % target_participants)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    def set_target_experiments(self, target_experiments):
        current_app.logger.info("set target experiments of the NodalCoordinatorDetail : %s" % target_experiments)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    @staticmethod
    def get_all():
        current_app.logger.info("get all rows of WorkshopReport entity")
...
#+BEGIN_SRC python :tangle src/db.py :eval no 
    @staticmethod
    def get_by_id(id):
        current_app.logger.info("get by WorkshopReport id")
...
#+BEGIN_SRC python :tangle src/db.py :eval no 
    @typecheck(path=str)
    def set_path(self, path):
        current_app.logger.info("set path of the  WorkshopReport: %s" % path)
...
#+BEGIN_SRC python :tangle src/db.py :eval no 
    @typecheck(name=str)
    def set_name(self, name):
        current_app.logger.info("set name of the  WorkshopReport: %s" % name)
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def set_workshop(self, workshop):
        current_app.logger.info("set workshop of the  WorkshopReport: %s" % workshop)
...
**** GET APIS
#+BEGIN_SRC python :tangle src/api.py :eval 
@api.route("/")
def index():
...
def save_workshop_documents(id):
    ...
    if request.method == 'POST':
        ...
        if response.ok:
            ...
            current_app.logger.error("response code = %s" % response)
            current_app.logger.debug("No entry for 'WorkshopReports' entity with given id")
...
def upload_file(file, url):
    if file and allowed_file(file.filename):
        ...
        try:
            path = {'path': db_path}
            current_app.logger.debug("db path is set successfully")
        except Exception, e:
            current_app.logger.error("Error unable to set db_path: " + str(e))
            raise e
            abort(500, 'error is %s' % (str(e)))
...
def modify_entity(entity, id):
    ...
    if request.method == 'PUT':
        ...
        current_app.logger.error("Updating record of %s Entity with id: %s" % (curr_entity, id))
...
def delete_record(entity, id):
    ...
    if not record:
        ...
        current_app.logger.error("No %s exists with id %s"  % (entity, id))		
        ...
        try:
            if entity.__name__=="WorkshopReport" or entity.__name__=="ReferenceDocument":
                if record.path==None:
                    record.delete()
      	            current_app.logger.info("The record of %s entity deleted sucessfully..." % entity)
                    ...
                    os.remove(file_loc)
                    current_app.logger.info("Deleted file from location %s:" % file_loc)
                    current_app.logger.debug("Deleted file from location %s:" % file_loc)

                    record.delete()
                    current_app.logger.info("Deleted record of %s Entity with id: %s" % (entity, id))
...
def update_record(entity_name, entity, id):
    ...
    if not record:
       	current_app.logger.error("No %s with id %s"  % (entity_name, id))
        abort(404, "No %s with id %s" % (entity_name, id))

    data = parse_request(request)
    if not data or type(data) is not dict:
    	current_app.logger.error("The data should be in JSON format")
    ...
    try:
        record.update(**data)
    	current_app.logger.info("The data of %s entity updated sucessfully..." % entity_name)
...
def typecast_data(entity, data):
    ...
    for attr, val in data.iteritems():
        if attr not in entity_map_types[entity]['types']:
            current_app.logger.error("%s attribute not in %s"  % (attr, entity))
...
def create_entity(entity):
    if entity not in entity_map_types:
        current_app.logger.info("creating entity...")
        current_app.logger.debug("Entity %s not present in entity map types"  % entity)
        current_app.logger.error("Entity %s is not valid."  % entity)
        abort(400, 'Entity %s is not valid.' % entity)
...
def create_record(entity_name, entity):
    ...
    data = parse_request(request)
    if not data or type(data) is not dict:
        current_app.logger.debug("Unsupported data...")
        current_app.logger.error("The data should be in JSON format")
        abort(400, "The data should be in JSON format")
    ...
    try:
        current_app.logger.info("creating record...")
        new_record = entity(**data)
        new_record.save()
        current_app.logger.info("Record of %s entity created sucessfully..." % entity_name)
    except Exception, e:
        current_app.logger.debug("Unable create new record...")
        current_app.logger.error("Error is %s" % (str(e)))
        abort(500, str(e))
...
class TestReferenceDocument(TestCase):
    ...
    def test_get_all_reference_documents(self):
        ...
        document1 = ReferenceDocument(name=Name("Attendance Sheet"), user=user1)
        document1.save()
        document2 = ReferenceDocument(name=Name("College Report"), user=user1)
        document2.save()
    ...
    def test_get_one_reference_document(self):
        ...
        doc1 = ReferenceDocument(name=Name("College Report"), user=user1)
        doc1.save()
        doc2 = ReferenceDocument(name=Name("Attendance Sheet"), user=user1)
        doc2.save()
    ...
    def test_delete_reference_document(self):
        ...
        doc1 = ReferenceDocument(name=Name("Feedback"), user=user1)
        doc1.save()
        doc2 = ReferenceDocument(name=Name("College Report"), user=user1)
        doc2.save()
        r = self.client.delete('/reference_documents/1')
        r = self.client.get('/reference_documents')
        result = json.loads(r.data)
        self.assertEqual(len(result), 1)
...
class TestNodalCentre(TestCase):
    ...
    def test_delete_nodal_centre(self):
        ...
        r1 = self.client.delete('/nodal_centres/1')
...
class TestNodalCoordinatorDetail(TestCase):
    ...
    def test_delete_nc_details(self):
        ...
        r = self.client.delete('/nodal_coordinator_details/1')
        r = self.client.get('/nodal_coordinator_details')
        result = json.loads(r.data)
        self.assertEqual(len(result), 1)
#+END_SRC
...
class TestWorkshopReport(TestCase):
    ...
    def test_delete_workshop_report(self):
        ...
        r = self.client.delete('/workshop_reports/1')
        r = self.client.get('/workshop_reports')
        result = json.loads(r.data)
        self.assertEqual(len(result), 1)
