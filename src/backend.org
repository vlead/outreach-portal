...
@api.route('/upload_document/<string>', methods=['GET', 'POST'])
def save_file(string):
    print string
    named_arguments = string.split(";")
    name = named_arguments[0].split("=")[1]
    user_id = named_arguments[1].split("=")[1]
    ...
    if request.method == 'POST':
        ...
        dir_path = "%s%s" % ("/home/vlead/Desktop/outreach-docs/", user_id)
        ...
        workshop_document = WorkshopDocument(name=response['name'],\
