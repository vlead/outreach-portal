...
#+BEGIN_SRC python :tangle tests/test_db.py :eval no
    def test_workshop_documents_get_all(self):
        ...
        doc = WorkshopDocument(name=Name("Attendance Sheet"), path="/workshop-docs/admin")
        doc.save()
...
#+BEGIN_SRC python :tangle tests/test_db.py :eval no 
    def test_get_workshop_document_by_id(self):
        ...
        workshop_document = WorkshopDocument(name=Name("Attendance Sheet"), path="/workshop-documents/admin")
...
#+BEGIN_SRC python :tangle tests/test_db.py :eval no
    def test_set_workshop_document_name(self):
        ...
        workshop_document = WorkshopDocument(name=Name("Attandance Sheet"), path="/workshop-documents/admin")
...
#+BEGIN_SRC python :tangle tests/test_db.py :eval no
    def test_workshop_document_to_client(self):
        ...
        doc = WorkshopDocument(name=Name("Feedback"), path="/workshop-docs/admin")
        doc.save()
...
def login():
    if request.method == 'POST':
        ...
        if verification_data['status'] == 'okay':
            backend_resp = requests.get("http://localhost:5000/users?email="
                                        +verification_data['email'])
            if (len(backend_resp.text.encode('ascii')) != 2):
                session['email'] = verification_data['email']
                if backend_resp.json()[0]['email'].encode('ascii') == str(session['email']):
                    return 'Okay'
            else:
                return 'Invalid'
...
class TestWorkshopDocument(TestCase):
    ...
    def test_get_all_workshop_documents(self):
        ...
        document1 = WorkshopDocument(name=Name("Attendance Sheet"), path="/workshop-documents/admin")
        document1.save()
        document2 = WorkshopDocument(name=Name("College Report"), path="/workshop-documents/admin")
        document2.save()
    ...
    def test_get_one_workshop_document(self):
        ...
        doc1 = WorkshopDocument(name=Name("College Report"), path="/workshop-documents/admin")
        doc1.save()
        doc2 = WorkshopDocument(name=Name("Attendance Sheet"), path="/workshop-documents/admin")
        doc2.save()
    ...
    def test_delete_workshop_document(self):
        ...
        doc1 = WorkshopDocument(name=Name("Feedback"), path="/workshop-docs/admin")
        doc1.save()
        doc2 = WorkshopDocument(name=Name("College Report"), path="/workshop-docs/admin") 
        doc2.save()
