...
#+BEGIN_SRC python :tangle src/db.py :eval no
        ...
        self.user_status = user_status.value
#+END_SRC
...
class NodalCentre(Entity):
    ...
    id = db.Column(db.Integer, primary_key=True)
    name = db.Column(db.String(128), nullable=False)
    centre_status = db.Column(db.String(128), nullable=False)
    location = db.Column(db.String(128))
...
#+BEGIN_SRC python :tangle src/db.py :eval no
    ...
    def __str__(self):
        return "Name = %s, location = %s, centre_status = %s, created_by = %s" % \
            (self.name, self.location, self.centre_status, self.created_by)
...
***** Test getCentreStatus: NodalCentre --> CentreStatus 
#+BEGIN_SRC python :tangle tests/test_db.py :eval no 
    def test_get_nodal_centre_name(self):
        print "test_get_nodal_centre_name"
        role1 = Role(name=Name("OC"))
