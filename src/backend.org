...
#+BEGIN_SRC python :tangle tests/test_db.py :eval no
    def test_get_all_users(self):
        ...
        user1 = User(name="ambika", email="ambika@vlabs.ac.in", role=role)
        user2 = User(name="madhavi", email="madhavi@vlabs.ac.in", role=role)
...
#+BEGIN_SRC python :tangle tests/test_db.py :eval no
    def test_get_user_toc(self):
        ...
        self.assertEqual(user_toc, time)
#+END_SRC
...
#+BEGIN_SRC python :tangle tests/test_db.py :eval no
    def test_get_user_last_act(self):
        ...
        self.assertEqual(user_last_act, datetime.utcnow())
#+END_SRC
...
#+BEGIN_SRC python :tangle tests/test_db.py :eval no
    def test_get_all_workshop_documents(self):
        ...
        document1 = WorkshopDocument(name="Attandance Sheet", path="/workshop-documents/admin")
        document1.save()
