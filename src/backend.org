                ...
                for workshop in ws_dict:
                    ...
                    try:
                        if user_response.ok:
                            ...
                            elif users_dict[0]['role']['id'] == 3 and \
                              users_dict[0]['institute_name'] is not None:
                                print"NC user dict = %s" % user_dict[0]
                                ncd_url = APP_URL + "/nodal_coordinator_details/" + str(user_id)
                                ...
                                try:
                                    if ncd_response.ok:
                                        ...
                                        institute_name = nc_users_dict['created_by']['institute_name']
